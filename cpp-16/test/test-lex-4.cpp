...
#include <quick-lint-js/fe/lex-4.h>
...
namespace {
class test_lex_4 : public ::testing::Test {
 protected:
  ...
  lexer_4& make_lexer(padded_string_view input, diag_collector* errors) {
    return this->lexers_.emplace_back(input, errors);
  }

  // If true, tell check_tokens_with_errors, lex_to_eof, etc. to call
  // lexer_4::skip_in_jsx instead of lexer_4::skip. This has no effect on the first
  // token.
  bool lex_jsx_tokens = false;

 private:
  linked_vector<lexer_4> lexers_ = linked_vector<lexer_4>(new_delete_resource());
};

TEST_F(test_lex_4, lex_block_comments) {
...
TEST_F(test_lex_4, lex_unopened_block_comment) {
  {
    diag_collector v;
    padded_string input(u8"hello */"_sv);
    lexer_4 l(&input, &v);  // identifier
...
TEST_F(test_lex_4, lex_regexp_literal_starting_with_star_slash) {
  {
...
TEST_F(test_lex_4, lex_regexp_literal_starting_with_star_star_slash) {
  {
...
TEST_F(test_lex_4, lex_line_comments) {
...
TEST_F(test_lex_4, lex_line_comments_with_control_characters) {
...
TEST_F(test_lex_4, lex_html_open_comments) {
  EXPECT_THAT(this->lex_to_eof(u8"<!-- --> hello"_sv), IsEmpty());
  for (string8_view line_terminator : line_terminators) {
    this->check_single_token(
        u8"<!-- hello" + string8(line_terminator) + u8"world", u8"world");
...
TEST_F(test_lex_4, lex_html_close_comments) {
...
TEST_F(test_lex_4, lex_binary_numbers) {
...
TEST_F(test_lex_4, fail_lex_integer_loses_precision) {
...
TEST_F(test_lex_4, fail_lex_binary_number_no_digits) {
  this->check_tokens_with_errors(
...
TEST_F(test_lex_4, fail_lex_binary_number) {
  this->check_tokens_with_errors(
...
TEST_F(test_lex_4, lex_modern_octal_numbers) {
...
TEST_F(test_lex_4, fail_lex_modern_octal_number_no_digits) {
  this->check_tokens_with_errors(
...
TEST_F(test_lex_4, fail_lex_modern_octal_numbers) {
  this->check_tokens_with_errors(
...
TEST_F(test_lex_4, lex_legacy_octal_numbers_strict) {
...
TEST_F(test_lex_4, lex_legacy_octal_numbers_lax) {
...
TEST_F(test_lex_4, fail_lex_legacy_octal_numbers) {
  this->check_tokens_with_errors(
...
TEST_F(test_lex_4, legacy_octal_numbers_cannot_contain_underscores) {
  this->check_tokens_with_errors(
...
TEST_F(test_lex_4, lex_hex_numbers) {
...
TEST_F(test_lex_4, fail_lex_hex_number_no_digits) {
  this->check_tokens_with_errors(
...
TEST_F(test_lex_4, fail_lex_hex_number) {
  this->check_tokens_with_errors(
...
TEST_F(test_lex_4, lex_number_with_trailing_garbage) {
  this->check_tokens_with_errors(
...
TEST_F(test_lex_4, lex_decimal_number_with_dot_method_call_is_invalid) {
...
TEST_F(test_lex_4, lex_invalid_big_int_number) {
  this->check_tokens_with_errors(
...
TEST_F(test_lex_4, lex_number_with_double_underscore) {
  this->check_tokens_with_errors(
...
TEST_F(test_lex_4, lex_number_with_many_underscores) {
  this->check_tokens_with_errors(
...
TEST_F(test_lex_4, lex_number_with_multiple_groups_of_consecutive_underscores) {
  {
    diag_collector v;
...
TEST_F(test_lex_4, lex_number_with_trailing_underscore) {
  this->check_tokens_with_errors(
...
TEST_F(test_lex_4, lex_number_with_trailing_underscores) {
  this->check_tokens_with_errors(
...
TEST_F(test_lex_4, lex_string_with_ascii_control_characters) {
  for (string8_view control_character :
...
TEST_F(test_lex_4, string_with_curly_quotes) {
  // Curly single quotes:
  this->check_tokens_with_errors(
...
TEST_F(test_lex_4, lex_templates) {
...
world`)",
...

  {
    ...
    lexer_4 l(&code, &null_diag_reporter::instance);
...
TEST_F(test_lex_4, templates_buffer_unicode_escape_errors) {
  {
    padded_string input(u8"`hello\\u`"_sv);
    diag_collector errors;
    lexer_4& l = this->make_lexer(&input, &errors);
...
TEST_F(test_lex_4, templates_do_not_buffer_valid_unicode_escapes) {
  {
...
TEST_F(test_lex_4, lex_template_literal_with_ascii_control_characters) {
  for (string8_view control_character :
...
TEST_F(test_lex_4, lex_regular_expression_literals) {
  auto check_regexp = [](string8_view raw_code) {
    padded_string code(raw_code);
    SCOPED_TRACE(code);
    diag_collector errors;
    lexer_4 l(&code, &errors);
...
TEST_F(test_lex_4, lex_regular_expression_literal_with_digit_flag) {
  padded_string input(u8"/cellular/3g"_sv);

  lexer_4 l(&input, &null_diag_reporter::instance);
  EXPECT_EQ(l.peek().type, token_type::slash);
  l.reparse_as_regexp();
  EXPECT_EQ(l.peek().type, token_type::regexp);
...
TEST_F(test_lex_4, lex_unicode_escape_in_regular_expression_literal_flags) {
  diag_collector errors;
  padded_string input(u8"/hello/\\u{67}i"_sv);

  lexer_4 l(&input, &errors);
  l.reparse_as_regexp();
  EXPECT_EQ(l.peek().type, token_type::regexp);
  EXPECT_EQ(l.peek().begin, &input[0]);
  EXPECT_EQ(l.peek().end, &input[input.size()]);
...
TEST_F(test_lex_4, lex_non_ascii_in_regular_expression_literal_flags) {
  diag_collector errors;
...
TEST_F(test_lex_4, lex_regular_expression_literal_with_ascii_control_characters) {
  for (string8_view control_character :
       control_characters_except_line_terminators) {
    padded_string input(u8"/hello" + string8(control_character) + u8"world/");
    SCOPED_TRACE(input);
...
TEST_F(test_lex_4, split_less_less_into_two_tokens) {
...
TEST_F(test_lex_4, split_less_less_has_no_leading_newline) {
...
TEST_F(test_lex_4, split_greater_from_bigger_token) {
  {
    padded_string input(u8">>;"_sv);
    lexer_4 l(&input, &null_diag_reporter::instance);
...
TEST_F(test_lex_4, split_greater_from_bigger_token_has_no_leading_newline) {
  {
    padded_string input(u8"\n>>"_sv);
    lexer_4 l(&input, &null_diag_reporter::instance);
    EXPECT_EQ(l.peek().type, token_type::greater_greater);
...
TEST_F(test_lex_4, lex_identifiers) {
...
TEST_F(test_lex_4, ascii_identifier_with_escape_sequence) {
...
TEST_F(test_lex_4, non_ascii_identifier) {
...
TEST_F(test_lex_4, non_ascii_identifier_with_escape_sequence) {
...
TEST_F(test_lex_4, lex_identifier_with_malformed_escape_sequence) {
...
TEST_F(test_lex_4, lex_identifier_with_out_of_range_escaped_character) {
  this->check_single_token_with_errors(
...
TEST_F(test_lex_4, lex_identifier_with_out_of_range_utf_8_sequence) {
...
TEST_F(test_lex_4, lex_identifier_with_malformed_utf_8_sequence) {
  this->check_single_token_with_errors(
...
TEST_F(test_lex_4, lex_identifier_with_disallowed_character_escape_sequence) {
  this->check_single_token_with_errors(
...
TEST_F(test_lex_4, lex_identifier_with_disallowed_non_ascii_character) {
  this->check_single_token_with_errors(
...
TEST_F(test_lex_4, lex_identifier_with_disallowed_escaped_initial_character) {
...
TEST_F(test_lex_4, lex_identifier_with_disallowed_non_ascii_initial_character) {
  this->check_single_token_with_errors(
      u8"\u0816illegal", u8"\u0816illegal",
      [](padded_string_view input, const auto& errors) {
        EXPECT_THAT(errors,
...
TEST_F(test_lex_4, private_identifier_with_disallowed_escaped_initial_character) {
...
TEST_F(test_lex_4, lex_reserved_keywords) {
...
TEST_F(test_lex_4, lex_contextual_keywords) {
...
TEST_F(test_lex_4, lex_typescript_contextual_keywords) {
...
TEST_F(
  ...
  for (string8 keyword : disallowed_binding_identifier_keywords) {
    ...
    SCOPED_TRACE(code);
    diag_collector errors;
    lexer_4& l = this->make_lexer(&code, &errors);
...
TEST_F(test_lex_4, lex_single_character_symbols) {
...
TEST_F(test_lex_4, lex_multi_character_symbols) {
...
TEST_F(test_lex_4, lex_adjacent_symbols) {
...
TEST_F(test_lex_4, lex_symbols_separated_by_whitespace) {
  this->check_tokens(u8"{ }"_sv,
                     {token_type::left_curly, token_type::right_curly});
...
TEST_F(test_lex_4, question_followed_by_number_is_not_question_dot) {
  this->check_tokens(u8"?.3"_sv, {token_type::question, token_type::number});
}

TEST_F(test_lex_4, question_dot_followed_by_non_digit_is_question_dot) {
  this->check_tokens(u8"?.e"_sv,
                     {token_type::question_dot, token_type::identifier});
}

TEST_F(test_lex_4, lex_whitespace) {
...
TEST_F(test_lex_4, lex_unexpected_bom_before_shebang) {
...
TEST_F(test_lex_4, lex_invalid_common_characters_are_disallowed) {
  {
    diag_collector v;
...
TEST_F(test_lex_4, ascii_control_characters_are_disallowed) {
...
TEST_F(test_lex_4, ascii_control_characters_sorta_treated_like_whitespace) {
  for (string8_view control_character : control_characters_except_whitespace) {
...
TEST_F(test_lex_4, lex_token_notes_leading_newline) {
  for (string8_view line_terminator : line_terminators) {
...
TEST_F(test_lex_4, lex_token_notes_leading_newline_after_single_line_comment) {
  for (string8_view line_terminator : line_terminators) {
...
TEST_F(test_lex_4, lex_token_notes_leading_newline_after_comment_with_newline) {
  for (string8_view line_terminator : line_terminators) {
...
TEST_F(test_lex_4, lex_token_notes_leading_newline_after_comment) {
...
TEST_F(test_lex_4, inserting_semicolon_at_newline_remembers_next_token) {
...
TEST_F(test_lex_4, insert_semicolon_at_beginning_of_input) {
...
TEST_F(test_lex_4, inserting_semicolon_at_right_curly_remembers_next_token) {
...
TEST_F(test_lex_4, transaction_buffers_errors_until_commit) {
  ...
  lexer_transaction_4 transaction = l.begin_transaction();
  l.skip();
  EXPECT_EQ(l.peek().type, token_type::number);
  EXPECT_THAT(errors.errors, IsEmpty())
...
TEST_F(test_lex_4, nested_transaction_buffers_errors_until_outer_commit) {
  ...
  lexer_transaction_4 outer_transaction = l.begin_transaction();
  l.skip();
  EXPECT_EQ(l.peek().type, token_type::identifier);  // y

  lexer_transaction_4 inner_transaction = l.begin_transaction();
  l.skip();
...
TEST_F(test_lex_4, rolled_back_inner_transaction_discards_errors) {
  padded_string code(u8"x y 0b z"_sv);
  diag_collector errors;
  lexer_4 l(&code, &errors);
...
TEST_F(test_lex_4, rolled_back_outer_transaction_discards_errors) {
  padded_string code(u8"x y 0b z"_sv);
  diag_collector errors;
  lexer_4 l(&code, &errors);
...
TEST_F(test_lex_4, errors_after_transaction_commit_are_reported_unbuffered) {
...
TEST_F(test_lex_4, errors_after_transaction_rollback_are_reported_unbuffered) {
  padded_string code(u8"x 'y' 0b"_sv);
  diag_collector errors;
  lexer_4 l(&code, &errors);
...
TEST_F(test_lex_4, rolling_back_transaction) {
...
TEST_F(test_lex_4, insert_semicolon_after_rolling_back_transaction) {
  padded_string code(u8"x 'y' 3"_sv);
  diag_collector errors;
  lexer_4 l(&code, &errors);
...
TEST_F(test_lex_4, unfinished_transaction_does_not_leak_memory) {
  ...
  [[maybe_unused]] lexer_transaction_4 outer_transaction = l.begin_transaction();
  l.skip();

  [[maybe_unused]] lexer_transaction_4 inner_transaction = l.begin_transaction();
  l.skip();
...
TEST_F(test_lex_4,
  ...
  for (char32_t c = min_code_point; c <= max_code_point; ++c) {
    if (lexer_4::is_initial_identifier_character(c)) {
      char8 utf_8[10];
  ...
  for (std::size_t byte = 0; byte < is_valid_byte.size(); ++byte) {
    EXPECT_EQ(lexer_4::is_initial_identifier_byte(static_cast<char8>(byte)),
              is_valid_byte[byte])
        << "byte = 0x" << std::hex << byte;
  }
}

TEST_F(test_lex_4, is_identifier_byte_agrees_with_is_identifier_character) {
  constexpr char32_t min_code_point = U'\0';
  constexpr char32_t max_code_point = U'\U0010ffff';
  ...
  is_valid_byte[u8'\\'] = true;
  for (char32_t c = min_code_point; c <= max_code_point; ++c) {
    if (lexer_4::is_identifier_character(c, lexer_4::identifier_kind::javascript)) {
      char8 utf_8[10];
      encode_utf_8(c, utf_8);
      is_valid_byte[static_cast<std::uint8_t>(utf_8[0])] = true;
    }
  ...
  for (std::size_t byte = 0; byte < is_valid_byte.size(); ++byte) {
    EXPECT_EQ(lexer_4::is_identifier_byte(static_cast<char8>(byte)),
              is_valid_byte[byte])
        << "byte = 0x" << std::hex << byte;
  }
}

TEST_F(test_lex_4, jsx_identifier) {
...
TEST_F(test_lex_4, invalid_jsx_identifier) {
...
TEST_F(test_lex_4, jsx_string_ignores_comments) {
  {
    padded_string code(u8"! 'hello // '\nworld'"sv);
    diag_collector errors;
    lexer_4 l(&code, &errors);
...
TEST_F(test_lex_4, unterminated_jsx_string) {
...
TEST_F(test_lex_4, jsx_text_children) {
  {
    padded_string code(u8"<>hello world"_sv);
    diag_collector errors;
    lexer_4 l(&code, &errors);
  ...
  // '>=' might be interpreted as greater_equal by a buggy lexer_4, for example.
...
TEST_F(test_lex_4, jsx_illegal_text_children) {
  {
    padded_string code(u8"<>hello>world</>"_sv);
    diag_collector errors;
    lexer_4 l(&code, &errors);
...
TEST_F(test_lex_4, jsx_expression_children) {
  this->lex_jsx_tokens = true;
...
TEST_F(test_lex_4, jsx_nested_children) {
  this->lex_jsx_tokens = true;
...
void test_lex_4::check_single_token(string8_view input,
                                  string8_view expected_identifier_name,
...
void test_lex_4::check_single_token_with_errors(
    string8_view input, string8_view expected_identifier_name,
    void (*check_errors)(padded_string_view input,
                         const std::vector<diag_collector::diag>&),
...
void test_lex_4::check_tokens_with_errors(
    string8_view input, std::initializer_list<token_type> expected_token_types,
    void (*check_errors)(padded_string_view input,
                         const std::vector<diag_collector::diag>&),
    source_location caller) {
...
std::vector<token> test_lex_4::lex_to_eof(padded_string_view input,
                                        source_location caller) {
  diag_collector errors;
...
std::vector<token> test_lex_4::lex_to_eof(string8_view input,
                                        source_location caller) {
