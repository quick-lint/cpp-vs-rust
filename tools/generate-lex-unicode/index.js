...
function main() {
  ...
  let cplusplusOutputPath = path.join(
    __dirname,
    "..",
    "..",
    "cpp",
  ...
  console.log(`Creating ${cplusplusOutputPath} ...`);
  writeCPlusPlus(fs.createWriteStream(cplusplusOutputPath), {
    allChunks,
    chunkDataToIndex,
    zerosChunkIndex,
    identifierStartData,
  ...
  writeRust(fs.createWriteStream(rustOutputPath), {
    allChunks,
    chunkDataToIndex,
    zerosChunkIndex,
    identifierStartData,
